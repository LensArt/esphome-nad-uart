...
The UART read line sensor used for ESPHome is based on the [UART Read line Sensor](https://github.com/wez/ESPHome-UART-Read-Line-Sensor) compononent. Credits to [@wez](https://github.com/wez/) for creating [this example](https://github.com/wez/ESPHome-UART-Read-Line-Sensor/blob/main/example_component1.yaml#L35) which helped a lot in updating the implementation
